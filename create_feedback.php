            ...
            <main class="flex-1 overflow-auto p-3 sm:p-4 md:p-8 flex items-center justify-center">
                <div class="w-full max-w-6xl">
                    ...
                    <div class="bg-white rounded-lg shadow p-6 sm:p-8">
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Create New Feedback</h1>
                        <p class="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">Submit feedback or report an issue</p>
