            ...
            <main class="flex-1 overflow-auto p-3 sm:p-4 md:p-8">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-6">
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900">
                        ...
                        Booking Requests: Lobby vs App vs Webapp
                    </h1>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-gray-500">Webapp Bookings</p>
                                <p class="text-3xl font-bold text-purple-600"><?php echo $bookingStats['webapp']; ?></p>
                            </div>
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">Booking By</th>
                                </tr>
                            </thead>
