            ...
            <main class="flex-1 overflow-auto p-4 md:p-8">
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900">Ahmedabad</td>
                                    <td class="px-6 py-4 text-sm text-gray-600">Western Railways</td>
                                    <td class="px-6 py-4 text-sm text-gray-600">Ahmedabad Division</td>
                    ...
                    <div class="bg-gray-50 border-t border-gray-200 px-6 py-4 flex items-center justify-between">
                        <p class="text-sm text-gray-600">Showing <span class="font-medium">1-1</span> of <span class="font-medium">6</span> locations</p>
