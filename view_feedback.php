        ...
        <div class="flex-1 md:ml-64 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-auto p-3 sm:p-4 md:p-8">
                ...
                <div class="mb-6 flex items-center gap-2 text-xs sm:text-sm text-gray-600 overflow-x-auto">
                    ...
                    <i class="fas fa-chevron-right"></i>
                    <span class="text-gray-900 font-medium">View Feedback</span>
                </div>

                <!-- Header -->
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-6">
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900">All Feedback</h1>
                    <a href="create_feedback.php"
                        ...
                        <i class="fas fa-plus mr-2"></i> Create Feedback
                    </a>
                </div>
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900">Improve Room Booking</td>
                                    <td class="px-6 py-4 text-sm text-gray-600">Suggestion</td>
                                    <td class="px-6 py-4"><span class="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">New</span></td>
                                    <td class="px-6 py-4 text-sm">
                                        <button class="text-blue-600 hover:text-blue-800 hover:underline font-medium mr-3">View</button>
                    ...
                    <div class="bg-gray-50 border-t border-gray-200 px-6 py-4 flex items-center justify-between">
                        <p class="text-sm text-gray-600">Showing <span class="font-medium">1-1</span> of <span class="font-medium">1</span> feedback</p>
