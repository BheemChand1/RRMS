...
<body class="bg-gray-100">
        ...
        <div class="flex-1 md:ml-64 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-auto p-3 sm:p-4 md:p-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    <div class="bg-white rounded-lg shadow p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Request Source Distribution</h3>
                        <canvas id="wakeupPieChart" height="200"></canvas>
                    </div>
                    <div class="bg-white rounded-lg shadow p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Daily Trend</h3>
                        <canvas id="wakeupBarChart" height="200"></canvas>
                    </div>
                </div>
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">Wake Up Time</th>
    ...
    <script>
        // Pie Chart
        const pieCtx = document.getElementById('wakeupPieChart').getContext('2d');
        new Chart(pieCtx, {
            type: 'doughnut',
            data: {
                labels: ['App', 'RM Dashboard'],
                datasets: [{
                    data: [<?php echo $wakeupStats['app']; ?>, <?php echo $wakeupStats['dashboard']; ?>],
        ...
        // Bar Chart
        const barCtx = document.getElementById('wakeupBarChart').getContext('2d');
        new Chart(barCtx, {
            type: 'bar',
            data: {
