            ...
            <main class="flex-1 overflow-auto p-3 sm:p-4 md:p-8">
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900">Ahmedabad Division</td>
                                    <td class="px-6 py-4 text-sm text-gray-600">Western Railways</td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900">Rajkot Division</td>
                                    <td class="px-6 py-4 text-sm text-gray-600">Western Railways</td>
                                    <td class="px-6 py-4 text-sm">
                                        <button class="text-blue-600 hover:text-blue-800 hover:underline font-medium mr-3">Edit</button>
                                        <button class="text-red-600 hover:text-red-800 hover:underline font-medium">Delete</button>
                    ...
                    <div class="bg-gray-50 border-t border-gray-200 px-6 py-4 flex items-center justify-between">
                        <p class="text-sm text-gray-600">Showing <span class="font-medium">1-2</span> of <span class="font-medium">12</span> divisions</p>
