                                    ...
                                    <?php foreach ($divisions as $division): ?>
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 text-sm">
                                                <a href="edit_division.php?id=<?php echo $division['id']; ?>" class="text-blue-600 hover:text-blue-800 hover:underline font-medium mr-3">Edit</a>
                                                <a href="view_divisions.php?delete=<?php echo $division['id']; ?>" onclick="return confirm('Are you sure you want to delete this division?')" class="text-red-600 hover:text-red-800 hover:underline font-medium">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
